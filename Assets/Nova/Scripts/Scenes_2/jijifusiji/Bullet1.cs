...
public class Bullet1 : MonoBehaviour
{
    ...
    public bool enAbleToCatchCatchPoint = true;
    ...
    private void Start()
    {
        move = MoveMaster.GetComponent<Move1>();
        line = LineMaster.GetComponent<Line1>();
    }
    ...
    void Update()
    {
        ...
        {                                                 //子弹静止
            ...
            gameObject.transform.position = CatchPoint.transform.position;
    ...
    private void OnTriggerEnter2D(Collider2D collision)
    {
        ...
        if (collision.name == "CatchPoint" && enAbleToCatchPlayer == true && enAbleToCatchCatchPoint != false)
        {
            GameObject tree = collision.gameObject;                             //寻找目标树
